...
<head>
    ...
    <%--<link href="${pageContext.request.contextPath }/static/css/gradePaper.css" rel="stylesheet">--%>
    <link href="${pageContext.request.contextPath }/static/myjs/home/main.css" rel="stylesheet" type="text/css"/>
    <link href="${pageContext.request.contextPath }/static/myjs/home/test.css" rel="stylesheet" type="text/css"/>

    <script src="${pageContext.request.contextPath }/static/layui/layui.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath }/static/layui/lay/modules/table.js" type="text/javascript"></script>
    ...
    <div class="test_main">
        <div class="nr_left">
           ...
           border: none;
            ...
            font-size: 16px;" id="finish" onclick="pigaiFinish()">批改完成
                </button>
            </div>
        </div>
